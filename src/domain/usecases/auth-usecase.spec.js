...
const makeUpdateAccessTokenRepositorySpy = () => {
  ...
  updateAccessTokenRepositorySpy.user = {
    password: 'hashed_password',
    id: 'user_id'
  }
...
describe('Auth UseCase', () => {
  ...
  it('Should call UpdateAccessToken repository with correct userId', async () => {
    const { sut, tokenGeneratorSpy, loadUserByEmailRepositorySpy, updateAccessTokenRepositorySpy } = makeSut()
    await sut.auth('valid.email@email.com', 'valid_password')
